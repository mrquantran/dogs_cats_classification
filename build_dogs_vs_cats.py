...
# we have to do it because it will help us to perform mean subtraction when training the network
# mean subtraction helps to reduce the sensitivity of the network to the absolute intensity values
# of the images, making the network more robust to changes in lighting conditions
